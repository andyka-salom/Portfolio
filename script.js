document.addEventListener('DOMContentLoaded', () => {
    ...
    const certificationData = {
        ...
        cert4: {
            imgSrc: 'sertifikat_course.pdf', // Path to the PDF file for the modal
        ...
        cert5: {
            imgSrc: 'sertifikat_course_aws.pdf', // Path to the PDF file for the modal
            ...
            link: null // Use null or '#' if no validation link
        }
    };
    // ********************************************
