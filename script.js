document.addEventListener('DOMContentLoaded', () => {
    ...
    const certificationData = {
        cert1: {
            imgSrc: 'images/cert-aws-full.png', // Full image for modal
